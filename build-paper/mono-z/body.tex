...
\begin{abstract}
  ...
  Five Neural Spline Flows~(NSFs)@@TOK:CITE:Durkan2019,Papamakarios2021@@ are trained
...
\section{@@TOK:HEADID:paper-sec-introduction@@@@TOK:SECNUM:1. @@Introduction}
...
transverse momentum ($\MET$) recoiling against visible final-state objects@@TOK:CITE:Goodman2011@@.
...
boson@@TOK:CITE:Bell2012,Carpenter2013,DMForum2015@@.

Published LHC searches in this final state have progressed from early reinterpretations
and multivariate projections to full Run~2 results from CMS and ATLAS@@TOK:CITE:Alves2015,CMS2017MonoZ,CMS2021MonoZ@@.
...
ATLAS/CMS Dark Matter Forum benchmark framework@@TOK:CITE:DMForum2015@@.
Complementary mono-$Z$ and mono-$Z'$ phenomenology has also been studied through dilepton
mass spectra, angular distributions, and resonance-plus-$\MET$ topologies@@TOK:CITE:Autran2015,Altmannshofer2015,Yang2017,Elgammal2024@@.
...
densities.
Neural Spline Flows (NSFs)@@TOK:CITE:Durkan2019,Papamakarios2021@@ model the SM background and
...
Normalizing flows supply exact density evaluation for correlated inputs@@TOK:CITE:Papamakarios2021,Reyes2022@@,
and surjective or simulation-aware extensions have been explored for collider event
modeling and anomaly detection@@TOK:CITE:Verheyen2022,Andreassen2020@@.
Our implementation uses CMS Run~2015D open data@@TOK:CITE:CERNOpenDataDoubleMuon,CERNOpenDataDoubleEG@@
for SM-dominated control samples and publicly released MonoZToLL MC samples with
vector, axial-vector, and scalar mediators@@TOK:CITE:CERNOpenDataMonoZVector,CERNOpenDataMonoZAxialMx10Mv20,CERNOpenDataMonoZAxialMx50Mv200,CERNOpenDataMonoZScalar@@
...
Section~@@TOK:REF:sec:literature@@ reviews the mono-$Z$ literature and related machine-learning
methods in more detail.
Section~@@TOK:REF:sec:objective@@ states the analysis regions and score definition used here;
Section~@@TOK:REF:sec:outline@@ summarizes our contributions and the paper structure.
...
\subsection{@@TOK:HEADID:paper-sec-objective@@@@TOK:SECNUM:1.1 @@Analysis objective}
...
(Section~@@TOK:REF:sec:datasets@@), so events enter the fit through \MET\
...
one per signal hypothesis@@TOK:CITE:Cowan2011@@.

\subsection{@@TOK:HEADID:paper-sec-outline@@@@TOK:SECNUM:1.2 @@Contributions and paper outline}
...
\begin{enumerate}
  ...
  \item final SR profile-likelihood fits and $\mathrm{CL}_{s}$ limits for the Run~2015D dataset.
\end{enumerate}

Section~@@TOK:REF:sec:datasets@@ lists data and MC inputs.
Section~@@TOK:REF:sec:preprocessing@@ describes feature extraction and cleaning.
Section~@@TOK:REF:sec:regions@@ defines CR, validation, and SR event categories.
Section~@@TOK:REF:sec:nsf@@ summarizes NSF architecture and training.
Section~@@TOK:REF:sec:search@@ details the score, fit, and cross-checks.
Section~@@TOK:REF:sec:results@@ presents distributions and limits.
Section~@@TOK:REF:sec:summary@@ concludes.

\section{@@TOK:HEADID:paper-sec-literature@@@@TOK:SECNUM:2. @@Literature Review}

\subsection{@@TOK:HEADID:paper-sec-lit-pheno@@@@TOK:SECNUM:2.1 @@Collider constraints and mono-Z phenomenology}
...
DM and spin-dependent scattering@@TOK:CITE:Goodman2011@@.
...
model@@TOK:CITE:Bell2012@@.
Ref.@@TOK:CITE:Carpenter2013@@ extended mono-$X$ reinterpretations to events with a
...
against DM alone.
Ref.@@TOK:CITE:Autran2015@@ studied $\MET$ in association with a dilepton or dijet resonance
from a $Z'$ boson, highlighting sensitivity in mass regions where standard resonance
searches lose efficiency.
Ref.@@TOK:CITE:Altmannshofer2015@@ pointed out that DM with scalar mediators can induce
...
Ref.@@TOK:CITE:Berlin2015@@ discussed pseudoscalar-portal fermion DM in two-Higgs-doublet
setups, where chiral couplings suppress direct detection while preserving thermal relic
targets.
Ref.@@TOK:CITE:Liew2017@@ compared mono-$X$ searches with direct searches for the mediating
...
Ref.@@TOK:CITE:Yang2017@@ showed that lepton angular distributions in the Collins--Soper frame
...
\subsection{@@TOK:HEADID:paper-sec-lit-experiment@@@@TOK:SECNUM:2.2 @@Simplified models, benchmarks, and experimental searches}

The ATLAS/CMS Dark Matter Forum report@@TOK:CITE:DMForum2015@@ codified simplified models
...
flow for hypothesis-specific scoring@@TOK:CITE:CERNOpenDataMonoZVector,CERNOpenDataMonoZAxialMx10Mv20,CERNOpenDataMonoZAxialMx50Mv200,CERNOpenDataMonoZScalar,DMForum2015@@.
...
scenarios@@TOK:CITE:CMS2017MonoZ,CMS2021MonoZ@@.
...
mediators, with comparisons to direct-detection cross sections@@TOK:CITE:CMS2021MonoZ@@.
Ref.@@TOK:CITE:Alves2015@@ projected the mono-$Z$ reach at $13$~TeV with a multivariate
...
High-mass dilepton searches from ATLAS@@TOK:CITE:ATLAS2016Dilepton,ATLAS2017Dilepton@@ bound
...
Refs.@@TOK:CITE:Autran2015,Elgammal2024@@.
Ref.@@TOK:CITE:Elgammal2024@@ applied CMS open data from Run~1 to dimuon angular distributions
at high $m_{\mu\mu}$, interpreting the data in a mono-$Z'$ simplified model and finding
agreement with SM Drell--Yan expectations.

\subsection{@@TOK:HEADID:paper-sec-lit-ml@@@@TOK:SECNUM:2.3 @@Density estimation and learning-based search methods}

Normalizing flows map a simple base density to a target distribution through invertible
transformations, enabling both sampling and exact likelihood evaluation@@TOK:CITE:Papamakarios2021@@.
Neural Spline Flows replace elementwise affine couplings with monotonic rational-quadratic
splines, increasing expressivity while retaining analytic inversion@@TOK:CITE:Durkan2019@@.
Ref.@@TOK:CITE:Reyes2022@@ examined how several flow architectures scale with input
dimensionality on toy HEP-like datasets, a relevant consideration for multivariate collider
features.
Ref.@@TOK:CITE:Verheyen2022@@ introduced surjective and stochastic flow layers to handle
...
studies.
Ref.@@TOK:CITE:Andreassen2020@@ proposed simulation-assisted likelihood-free anomaly detection
...
ANODE@@TOK:CITE:Nachman2020@@ and CATHODE@@TOK:CITE:Hallin2021@@; both construct signal-region
classifiers from control-region density ratios, a strategy adjacent to our direct NSF
log-ratio score.
Ref.@@TOK:CITE:Alves2015@@ remains the closest prior mono-$Z$ reference for multivariate
...
context and CR/SR philosophy of the experimental and Forum literature@@TOK:CITE:DMForum2015,CMS2021MonoZ@@,
but estimate SM and DM event densities with NSFs and use their log-ratio as the test
statistic, following asymptotic inference prescriptions@@TOK:CITE:Cowan2011@@ in the signal region.
...
\section{@@TOK:HEADID:paper-sec-datasets@@@@TOK:SECNUM:3. @@Datasets and Signal Model}

SM events come from CMS Run~2015D MINIAOD open data: the DoubleMuon primary dataset
(record~24127)@@TOK:CITE:CERNOpenDataDoubleMuon@@ and the DoubleEG primary dataset
(record~24132)@@TOK:CITE:CERNOpenDataDoubleEG@@, both at $\sqrt{s}=13$~TeV.
...
summarized in Appendix~@@TOK:REF:app:rows@@, and the complete feature schema with formulas is
given in Appendix~@@TOK:REF:app:features@@.

The signal inputs are MonoZToLL MINIAODSIM samples generated in the same
$\sqrt{s}=13$~TeV era for vector, axial-vector, and scalar mediators@@TOK:CITE:DMForum2015@@.
The vector sample is record~16630@@TOK:CITE:CERNOpenDataMonoZVector@@; the axial-vector inputs
combine records~16575 and~16597@@TOK:CITE:CERNOpenDataMonoZAxialMx10Mv20,CERNOpenDataMonoZAxialMx50Mv200@@;
the scalar sample is record~16601@@TOK:CITE:CERNOpenDataMonoZScalar@@.
...
40 physics branches listed in Appendix~@@TOK:REF:app:features@@ are written for data and MC; the
...
\begin{table}[!tbp]
\centering
\caption{@@TOK:CAPT:1@@ Event and object selections applied during feature extraction.}
...
\section{@@TOK:HEADID:paper-sec-preprocessing@@@@TOK:SECNUM:4. @@Feature Extraction and Cleaning}
...
Appendix~@@TOK:REF:app:features@@; Table~@@TOK:REF:tab:extraction-cuts@@ lists the selection cuts
...
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/closure_cr_ee.png}
\hfill
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/closure_cr_mumu.png}
...
\section{@@TOK:HEADID:paper-sec-regions@@@@TOK:SECNUM:5. @@Control and Signal Regions}
...
The SR imposes no explicit upper \MET\ requirement; in practice the
cleaned dataset caps \MET\ at approximately 200\,\GeV\
(Section~@@TOK:REF:sec:datasets@@).

\section{@@TOK:HEADID:paper-sec-nsf@@@@TOK:SECNUM:6. @@Neural Spline Flow Models}

Each NSF maps a feature vector $\mathbf{x}\in\mathbb{R}^d$ to a base density through a
composition of coupling layers with rational-quadratic spline transforms@@TOK:CITE:Durkan2019@@.
...
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/closure_vr_ee_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/closure_vr_ee_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/closure_vr_ee_axial.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/closure_vr_mumu_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/closure_vr_mumu_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/closure_vr_mumu_axial.png}
...
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr+vr/fit_result_ee_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr+vr/fit_result_ee_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr+vr/fit_result_ee_axial.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr+vr/fit_result_mumu_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr+vr/fit_result_mumu_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr+vr/fit_result_mumu_axial.png}
...
(Section~@@TOK:REF:sec:met-tail@@), not a genuine \(8\sigma\) discovery.
...
\section{@@TOK:HEADID:paper-sec-search@@@@TOK:SECNUM:7. @@Likelihood-Ratio Search}

The search uses $\score_h$ as the per-event test statistic for each mediator hypothesis
(Eq.~@@TOK:EQREF:eq:score@@).
...
\end{equation}@@TOK:EQA:eq-anon-2@@
...
Asymptotic formulae@@TOK:CITE:Cowan2011@@ are used for the discovery test statistic and $\mathrm{CL}_{s}$ upper limits.
\begin{figure}[t]
\centering

\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/sr_score_combined_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/sr_score_combined_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/nsf/sr_score_combined_axial.png}
...
\subsection{@@TOK:HEADID:paper-sec-systematics@@@@TOK:SECNUM:7.1 @@Systematic uncertainties}
...
taken from the CMS precision luminosity measurement@@TOK:CITE:CMS-LUM-2021@@.
...
energy@@TOK:CITE:CMS2017MonoZ@@. Lepton momentum-scale uncertainties of 1\%
...
residual (Section~@@TOK:REF:sec:met-tail@@).

\subsection{@@TOK:HEADID:paper-sec-met-tail@@@@TOK:SECNUM:7.2 @@High-\MET\ tail modelling residual}
...
(Section~@@TOK:REF:sec:extrapolation-validation@@).
...
\subsection{@@TOK:HEADID:paper-sec-extrapolation-validation@@@@TOK:SECNUM:7.3 @@NSF CR$\to$SR extrapolation validation}
...
(Section~@@TOK:REF:sec:met-tail@@) rather than an uncorrected prediction.

%===========================================================
\section{@@TOK:HEADID:paper-sec-results@@@@TOK:SECNUM:8. @@Results}
%===========================================================
\begin{figure}[t]
\centering

\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr+vr/cls_scan_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr+vr/cls_scan_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr+vr/cls_scan_axial.png}

\caption{@@TOK:CAPF:5@@ 
Asymptotic $\mathrm{CL}_{s}$ scans for the scalar, vector, and axial-vector mediator
...
-
\log p(\mathbf{x}\mid\mathrm{SM}_{\ell\ell})
\end{equation}@@TOK:EQA:eq-anon-3@@
...
Appendix~@@TOK:REF:app:sr-only-fit@@.
A pure VR-extrapolated shape alternative was also investigated but failed closure in the high-score tail; the corresponding VR-only post-fit distributions are provided in Appendix~@@TOK:REF:app:vr-extrapolation@@ as a diagnostic study and are not used for the final statistical interpretation.

The fitted score distributions for all mediator hypotheses and both lepton
channels are shown in Fig.~@@TOK:REF:fig:fit_results@@. In every case the observed
data show a pull relative to the VR-based background prediction, most
pronounced in the high-score tail (Section~@@TOK:REF:sec:met-tail@@).
The discovery test statistic \(q_0\) is large (233--327 across the three
hypotheses; Table~@@TOK:REF:tab:fit_summary@@), formally corresponding to a
...
than a dark matter signal (Sections~@@TOK:REF:sec:met-tail@@--@@TOK:REF:sec:extrapolation-validation@@).

Upper limits on the signal strength parameter $\mu$ were derived using the
asymptotic $\mathrm{CL}_{s}$ method. The resulting limits are summarized in
Table~@@TOK:REF:tab:fit_summary@@, while the corresponding confidence-level scans
are shown in Fig.~@@TOK:REF:fig:cls_scans@@. The scalar mediator provides the
...
modelling residual described in Section~@@TOK:REF:sec:met-tail@@. The superior
...
\section{@@TOK:HEADID:paper-sec-summary@@@@TOK:SECNUM:9. @@Summary and Outlook}
...
Table~@@TOK:REF:tab:fit_summary@@. The observed-to-expected gaps are driven by the
...
tail (Appendix~@@TOK:REF:app:vr-extrapolation@@) and is not used for the final limits.
...
\section*{@@TOK:HEADID:paper-appendix-note@@Appendix}


\section{@@TOK:HEADID:paper-sec-appendix@@@@TOK:SECNUM:10. @@Dataset and Extraction Summary}

\subsection{@@TOK:HEADID:paper-app-rows@@@@TOK:SECNUM:10.1 @@Rows read and extracted}

Table~@@TOK:REF:tab:appendix-rows@@ summarizes the row counts used after extraction.
...
\centering
\scriptsize
\caption{@@TOK:CAPT:3@@ Dataset-level rows read and rows extracted for the analysis inputs.}
...
\subsection{@@TOK:HEADID:paper-app-trigger-btag@@@@TOK:SECNUM:@.1 @@HLT trigger paths and b-tag configuration}

Table~@@TOK:REF:tab:appendix-trigger-btag@@ summarizes the trigger and $b$-tag settings
...
\centering
\scriptsize
\caption{@@TOK:CAPT:4@@ HLT trigger prefixes, fallback filter tokens, and $b$-tag configuration used during event extraction.}
...
\subsection{@@TOK:HEADID:paper-app-signal-points@@@@TOK:SECNUM:@.2 @@Signal MC parameter points}

Table~@@TOK:REF:tab:appendix-signal-points@@ lists the signal samples used for the three DM
density models. The parameter values are taken from the CERN Open Data sample names in
the local bibliography.

\begin{table}[h]
\centering
\caption{@@TOK:CAPT:5@@ MonoZToLL signal MC parameter points and extracted event counts.}
...
@@TOK:ENVEND:t5@@\end{table}
 
\section{@@TOK:HEADID:paper-app-feature-definitions@@@@TOK:SECNUM:A. @@Feature Definitions}

\subsection{@@TOK:HEADID:paper-app-features@@@@TOK:SECNUM:A.1 @@Physics feature branches}

The extraction notebooks write the 40 physics branches listed in
Tables~@@TOK:REF:tab:appendix-features@@ and~@@TOK:REF:tab:appendix-features-cont@@ to the output \texttt{Events} TTrees. The DoubleMuon,
...
\centering
\scriptsize
\caption{@@TOK:CAPT:6@@ Physics feature branches written by the extraction notebooks, part 1 of 2. Derived features include the formula used in the analysis code.}
\label{tab:appendix-features}
\begin{tabular}{>{\raggedright\arraybackslash}p{0.18\textwidth}>{\raggedright\arraybackslash}p{0.16\textwidth}>{\raggedright\arraybackslash}p{0.58\textwidth}}
\toprule
...
\centering
\scriptsize
\caption{@@TOK:CAPT:7@@ Physics feature branches written by the extraction notebooks, part 2 of 2.}
...
\bottomrule
\end{tabular}
@@TOK:ENVEND:t7@@\end{table}

\subsection{@@TOK:HEADID:paper-app-nsf-feature-order@@@@TOK:SECNUM:A.2 @@NSF input feature order}

Table~@@TOK:REF:tab:appendix-nsf-feature-order@@ gives the 37-dimensional input order used when
...
\centering
\scriptsize
\caption{@@TOK:CAPT:8@@ NSF input feature order used for SM and DM scoring.}
...
@@TOK:ENVEND:t8@@\end{table}


\section{@@TOK:HEADID:paper-app-data-cleaning@@@@TOK:SECNUM:B. @@Data Cleaning}

\subsection{@@TOK:HEADID:paper-app-cleaning@@@@TOK:SECNUM:B.1 @@Fixed domain bounds}

Table~@@TOK:REF:tab:appendix-cleaning-fixed@@ lists the fixed-domain bounds applied by the SM
cleaner. Features not shown in the fixed-bound table are either pass-through variables or
receive only the tail-rule treatment in Table~@@TOK:REF:tab:appendix-cleaning-tail@@.

\begin{table}[h]
\centering
\caption{@@TOK:CAPT:9@@ Fixed bounds applied during SM cleaning.}
...
@@TOK:ENVEND:t9@@\end{table}

\subsection{@@TOK:HEADID:paper-app-tail-caps@@@@TOK:SECNUM:B.2 @@Data-derived tail caps}

Table~@@TOK:REF:tab:appendix-cleaning-caps@@ lists the numerical caps stored in
...
\centering
\small
\caption{@@TOK:CAPT:10@@ Data-derived tail caps used by the SM feature-domain cleaner.}
...
@@TOK:ENVEND:t10@@\end{table}

\subsection{@@TOK:HEADID:paper-app-tail-rule-families@@@@TOK:SECNUM:B.3 @@Tail-rule families}

\begin{table}[H]
\centering
\caption{@@TOK:CAPT:11@@ High-quantile tail rules used by the SM cleaner. A positive rule bounds the feature below by zero and above by the estimated cap; a symmetric rule applies \([-\mathrm{cap},+\mathrm{cap}]\).}
...
@@TOK:ENVEND:t11@@\end{table}


\section{@@TOK:HEADID:paper-app-regions-yields@@@@TOK:SECNUM:C. @@Region Definitions and Event Yields}

\subsection{@@TOK:HEADID:paper-app-region-criteria@@@@TOK:SECNUM:C.1 @@Region selection criteria}

Table~@@TOK:REF:tab:appendix-region-criteria@@ records the CR, VR, and SR masks from
...
\begin{table}[h]
\centering
\caption{@@TOK:CAPT:12@@ Analysis region definitions used during scoring.}
...
@@TOK:ENVEND:t12@@\end{table}

\subsection{@@TOK:HEADID:paper-app-region-yields@@@@TOK:SECNUM:C.2 @@Event counts per region and channel}

Table~@@TOK:REF:tab:appendix-region-yields@@ summarizes the region counts stored in the scoring
...
\centering
\small
\caption{@@TOK:CAPT:13@@ Event counts after cleaning and region assignment.}
...
@@TOK:ENVEND:t13@@\end{table}


\section{@@TOK:HEADID:paper-app-fit-results@@@@TOK:SECNUM:D. @@Fit Configuration and Numerical Results}

\subsection{@@TOK:HEADID:paper-app-fit-configuration@@@@TOK:SECNUM:D.1 @@Fit configuration}

Table~@@TOK:REF:tab:appendix-fit-config@@ lists the final simultaneous SR+VR fit settings
...
\begin{table}[h]
\centering
\caption{@@TOK:CAPT:14@@ Profile-likelihood fit configuration.}
...
VR normalisation constraint & Per-channel $\theta_{\mathrm{norm}}$, prior width 0.05 \\
...
@@TOK:ENVEND:t14@@\end{table}

\subsection{@@TOK:HEADID:paper-app-full-fit-results@@@@TOK:SECNUM:D.2 @@Full fit results}

Table~@@TOK:REF:tab:appendix-fit-results@@ reports the numerical results from
...
Section~@@TOK:REF:sec:met-tail@@.

\begin{table}[h]
\centering
\caption{@@TOK:CAPT:15@@ Observed and expected fit results for the three mediator hypotheses from the simultaneous SR+VR profile-likelihood fit.}
...
@@TOK:ENVEND:t15@@\end{table}

\subsection{@@TOK:HEADID:paper-app-background-method@@@@TOK:SECNUM:D.3 @@Background estimation method note}
...
$\theta_{\mathrm{norm}}$ using $\sim$6,970 ($\mu\mu$) and $\sim$6,644 ($ee$)
VR events; the posterior uncertainty on $\theta_{\mathrm{norm}}$ is
...
\subsection{@@TOK:HEADID:paper-app-vr-extrapolation@@@@TOK:SECNUM:D.4 @@VR-extrapolated validation fit}
...
the resulting shape difference as a positive signal strength. Table~@@TOK:REF:tab:appendix-vr-fit@@
therefore records the VR-extrapolated fit as a diagnostic rather than as the final
limit result.

\begin{table}[t]
\centering
\caption{@@TOK:CAPT:16@@ VR-extrapolated validation fit. The large positive fitted signal
...
fit's 7.2--9.8\(\times\) gap (Table~@@TOK:REF:tab:fit_summary@@). This corroborates
...
\subsection{@@TOK:HEADID:paper-app-sr-only-fit@@@@TOK:SECNUM:D.5 @@SR-only validation fit}
...
The corresponding $\mathrm{CL}_{s}$ scans and post-fit distributions are shown in
Figs.~@@TOK:REF:fig:sr_cls_scans@@ and~@@TOK:REF:fig:sr_fit_results@@.
\begin{table}[h]
\centering
\caption{@@TOK:CAPT:17@@ SR-only validation fit. The fitted signal strengths remain positive
...
are capped as in Table~@@TOK:REF:tab:fit_summary@@.}
...
@@TOK:ENVEND:t17@@\end{table}

\section{@@TOK:HEADID:paper-app-results-figures@@@@TOK:SECNUM:E. @@Additional Validation Figures}
\subsection{@@TOK:HEADID:paper-app-figures-vr-closure@@@@TOK:SECNUM:E.1 @@VR-extrapolated CLs scans}

\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/vr/cls_scan_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/vr/cls_scan_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/vr/cls_scan_axial.png}
\caption{@@TOK:CAPF:6@@ $\mathrm{CL}_{s}$ scans for the VR-extrapolated validation fit. Observed
$\mathrm{CL}_{s}$ crosses the 95\% threshold for all three mediators once the scan
range brackets \(\hat{\mu}\); see Table~@@TOK:REF:tab:appendix-vr-fit@@.}
\label{fig:vr_cls_scans}
@@TOK:ENVEND:f6@@\end{figure}

\subsection{@@TOK:HEADID:paper-app-figures-vr-postfit@@@@TOK:SECNUM:E.2 @@VR-extrapolated post-fit distributions}

\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/vr/fit_result_ee_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/vr/fit_result_ee_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/vr/fit_result_ee_axial.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/vr/fit_result_mumu_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/vr/fit_result_mumu_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/vr/fit_result_mumu_axial.png}
\caption{@@TOK:CAPF:7@@ Post-fit score distributions for the VR-extrapolated validation fit.
...
\subsection{@@TOK:HEADID:paper-head-1@@@@TOK:SECNUM:E.3 @@SR-only CLs scans}
\begin{figure}[h]
\centering

\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr/cls_scan_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr/cls_scan_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr/cls_scan_axial.png}
...
\subsection{@@TOK:HEADID:paper-head-2@@@@TOK:SECNUM:E.4 @@SR-only post-fit distributions}
\begin{figure}[h]
\centering

\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr/fit_result_ee_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr/fit_result_ee_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr/fit_result_ee_axial.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr/fit_result_mumu_scalar.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr/fit_result_mumu_vector.png}
\includegraphics[width=0.48\textwidth]{/research/mono-z/assets/figures/sr/fit_result_mumu_axial.png}
